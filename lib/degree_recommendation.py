...
class DegreeRecommendation:
    ...
    def _get_jina_embedding(self, text):
        headers = {
    ...
    def _llm(self, user_prompt, system_prompt, model="gpt-4o-mini", temperature=0.5):
    ...
    def _search(self, selected_career: str, user_profile: str, limit: int = 1, collection_name="degree-information", model_handle="jinaai/jina-embeddings-v2-small-en"):
    ...
    def _format_prompt(self, career: str, career_quiz: str, degrees) -> tuple[str, str]:
        raw_user_prompt, syetem_prompt = self._load_prompts()
    ...
    def recommend_degree_program(self, selected_career: str, quiz_answers: list) -> tuple[list, str]:
        ...
        user_profile = self._generate_user_profile(quiz_answers=quiz_answers)
        ...
        user_prompt, system_prompt = self._format_prompt(
