...
def format_prompts(user_prompt, system_prompt, career_quiz, user_response):
    qna_user_prompt = user_prompt.format(user_response=json.dumps(user_response, indent=2))
    qna_system_prompt = system_prompt.format(career_quiz=json.dumps(career_quiz, indent=2))
...
def career_api(request):
    ...
    try:
        ...
        user_prompt, system_prompt = format_prompts(user_prompt_template, system_prompt_template, career_quiz, user_response)
